        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <div className="w-12 h-12 rounded-2xl bg-[#4B65E8] flex items-center justify-center mx-auto mb-4">
              <Zap size={22} className="text-white" strokeWidth={1.5} />
            </div>
            <h1 className="text-[24px] text-[#1C1C1E] tracking-tight mb-1.5">Welcome back</h1>
            <p className="text-[13px] text-[#6E6E7A]">Sign in to your Auditwise account</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-[12px] text-[#6E6E7A]">Password</label>
                  <button
                    type="button"
                    onClick={() => navigate("/forgot-password")}
                    className="text-[11px] text-[#4B65E8] hover:underline"
                  >
                    Forgot password?
                  </button>
                </div>
          ...
          <p className="text-center text-[12px] text-[#9595A0] mt-5">
            ...
            <button onClick={() => navigate("/signup")} className="text-[#4B65E8] hover:underline">
              Sign up free
            </button>
          </p>
        </div>
